...
export class SelfDeployer {
  private config: Required<SelfDeployerConfig>;
   ...
   */
  async validateModifications(modifications: CodeModification[]): Promise<boolean> {
   ...
   */
  private createStages(): DeploymentStage[] {
    return [
      {
        name: 'validate',
