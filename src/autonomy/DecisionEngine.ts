...
export class DecisionEngine {
   ...
   */
  private assessRisk(context: DecisionContext): RiskLevel {
   ...
   */
  private selectBestOption(context: DecisionContext): string {
   ...
   */
  private generateRationale(context: DecisionContext, choice: string, confidence: number): string {
    const evidenceCount = context.evidence.length;
   ...
   */
  private generateEscalationReason(confidence: number, riskLevel: RiskLevel): string {
    if (riskLevel === 'high') {
