/**
 * Signal Collector - Tracks observable signals for crash prediction
 */
...
export class SignalCollector {
  ...
  getCrashRisk(): CrashRisk {
    ...
    return this.assessRisk(signals);
  }
  ...
  getSignals(): CrashSignals {
    ...
    // Context window calculation (assume 200K tokens)
    const contextWindowSize = 200000;
    const contextWindowUsage = this.estimatedTotalTokens / contextWindowSize;
    const contextWindowRemaining = contextWindowSize - this.estimatedTotalTokens;
