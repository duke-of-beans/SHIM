 ...
 */
export type CheckpointTrigger = 'tool_call_interval' | 'time_interval' | 'danger_zone' | 'warning_zone' | 'risky_operation' | 'milestone' | 'user_requested' | 'session_start' | 'session_end';
export type CrashRisk = 'safe' | 'warning' | 'danger';
export type InterruptionReason = 'crash' | 'timeout' | 'manual_exit' | 'unknown';
